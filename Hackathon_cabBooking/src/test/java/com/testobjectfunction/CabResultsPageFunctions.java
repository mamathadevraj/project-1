...
public class CabResultsPageFunctions {
	...
	public static void setCabType(WebDriver driver, String cab)
	{
	...
	public static void setSortBy(WebDriver driver)
	{
		wait = new WebDriverWait(driver, 30);
	...
	public static void setSortOption(WebDriver driver, String option)
	{
		try {
	...
	public static String setPrice(WebDriver driver)
	{
